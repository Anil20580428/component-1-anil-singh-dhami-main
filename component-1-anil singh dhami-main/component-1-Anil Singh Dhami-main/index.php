...
set_include_path(get_include_path().PATH_SEPARATOR.'./'); // Add current directory to include path
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: index.php"); // Redirect to the same page to avoid resubmission
    exit;
}

if ($api_call) {
    $products = new \awe\JsonProductWriter();
} else {
    $products = new \awe\HtmlProductWriter();
}
